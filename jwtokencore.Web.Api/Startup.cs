...
using jwtokencore.Api.Core;
using jwtokencore.Api.Infrastructure;
using jwtokencore.Api.Infrastructure.Auth;
using jwtokencore.Api.Infrastructure.Data;
using jwtokencore.Api.Infrastructure.Extensions;
using jwtokencore.Api.Infrastructure.Helpers;
...
namespace jwtokencore.Web.Api
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddPolicy("api-user", policy => policy.RequireClaim(Constants.Strings.JwtClaimIdentifiers.Rol, Constants.Strings.JwtClaims.ApiAccess));
            });
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "JWToken .Net Core App", Version = "v1" });
                // Swagger 2.+ support
                c.AddSecurityDefinition("Bearer", new ApiKeyScheme
                {
                    In = "header",
                    Description = "Please insert [Bearer JWToken] into field",
                    Name = "Authorization",
                    Type = "apiKey"
                });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "JWToken .Net Core App V1");
            });
